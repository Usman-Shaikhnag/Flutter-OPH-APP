...
import '../mylibrary/constant.dart';
import '../mylibrary/circular_clipper.dart';
import '../mylibrary/overboard_animator.dart';
import '../mylibrary/page_model.dart';
import 'package:oph_app/reusable/cache_image_network.dart';
...
class _OverBoardState extends State<OverBoard> with TickerProviderStateMixin {
  ...
  _getStack() {
    final Color _color1 = Color(0xffa863b3);
